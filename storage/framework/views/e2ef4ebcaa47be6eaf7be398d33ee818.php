        ...
        <div class="card p-4 shadow-sm">
            ...
            <form action="<?php echo e(route('admin.produtos.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" placeholder="Digite o nome do produto" value="<?php echo e(old('nome')); ?>" required>
                </div>

                <div class="mb-3">
                    <label for="descricao" class="form-label">Descrição do produto:</label>
                    <textarea class="form-control" id="descricao" name="descricao" rows="3" placeholder="Digite uma breve descrição do produto"><?php echo e(old('descricao')); ?></textarea>
                </div>
...
</html><?php /**PATH /opt/lampp/htdocs/projetoweb-pizzaria/resources/views/admin/produtos/criar.blade.php ENDPATH**/ ?>