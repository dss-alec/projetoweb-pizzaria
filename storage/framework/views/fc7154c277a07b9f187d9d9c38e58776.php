...
<head>
    <meta charset="UTF-8">
    <title>Visualizar Mensagens - Pizzaria Delícia</title>
...
<section class="mensagens" style="padding-top: 0px; padding-bottom: 40px;">
    <div class="container">
        <h2 class="text-center mb-5 cardapio-titulo">Mensagens Recebidas</h2>
        <div class="row justify-content-center g-4">

            <?php $__empty_1 = true; $__currentLoopData = $mensagens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mensagem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-md-3">
                    <div class="card h-100 text-center">
                        <div class="card-body d-flex flex-column justify-content-between">
                            <h5 class="card-title"><?php echo e($mensagem->nome); ?></h5>
                            <p class="card-text"><strong>Email:</strong> <?php echo e($mensagem->email); ?></p>
                            <p class="card-text"><strong>Telefone:</strong> <?php echo e($mensagem->telefone); ?></p>
                            <p class="card-text mensagem-text"><?php echo e($mensagem->mensagem); ?></p>
                        </div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <p class="text-center">Nenhuma mensagem recebida até o momento.</p>
            <?php endif; ?>
