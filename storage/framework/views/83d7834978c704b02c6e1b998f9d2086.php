...
<img src="<?php echo e($produto->imagem ? asset('storage/' . $produto->imagem) : asset('img/default-pizza.jpg')); ?>" 
     ...
     alt="<?php echo e($produto->nome); ?>">
              ...
              <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                ...
                <p class="card-text"><?php echo e($produto->descricao ?? 'Sem descrição disponível.'); ?></p>
                <p class="preco-produto">R$ <?php echo e(number_format($produto->preco, 2, ',', '.')); ?></p>
...
<?php /**PATH /opt/lampp/htdocs/projetoweb-pizzaria/resources/views/produtos.blade.php ENDPATH**/ ?>