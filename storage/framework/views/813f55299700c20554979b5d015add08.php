  ...
  <section style="padding: 1.7rem 0; background-color: white;">
    <div style="width: 90%; max-width: 1200px; margin: 0 auto; display: flex; flex-wrap: wrap; align-items: center; gap: 2rem;">
      <div style="flex: 1 1 400px;">
        <img src="<?php echo e(asset('img/sobrenos.jpg')); ?>" alt="Pizza Delícia" style="display: block; width: 100%; max-width: 500px; height: auto; max-height: 400px; object-fit: cover; border-radius: 0.75rem; margin: 0 auto;">
      </div>
...
<?php /**PATH /opt/lampp/htdocs/projetoweb-pizzaria/resources/views/sobre-nos.blade.php ENDPATH**/ ?>