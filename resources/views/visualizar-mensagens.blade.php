                ...
                <div class="col-md-3">
                    <div class="card h-100 text-center">
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <p class="card-text"><strong>Email:</strong> {{ $mensagem->email }}</p>
                            <p class="card-text"><strong>Telefone:</strong> {{ $mensagem->telefone }}</p>
                            <p class="card-text mensagem-text">{{ $mensagem->mensagem }}</p>
                        </div>
                    </div>
                </div>
            @empty
